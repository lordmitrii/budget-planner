...
export const api = {
  ...
  getFxSettings: () => invoke<FxSettingsPayload>("get_fx_settings"),
  updateFxFallbacks: (input: FxFallbackInput) => invoke<FxSettingsPayload>("update_fx_fallbacks", { input }),
  refreshFxRates: () => invoke<FxRefreshResult>("refresh_fx_rates"),
